...
1. Get your [official update file](http://deu01.psv.update.playstation.net/update/psv/image/2022_0209/rel_f2c7b12fe85496ec88a0391b514d6e3b/PSVUPDAT.PUP) and the plugin from the releases,if you use a SD2Vita,use the uma0 version,if not use the normal version.
